...
<body>
    <nav class="navbar navbar-light navbar-expand-md shadow-sm">
        <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1"><img src="./assets/img/logo-plataforma.png">
                <ul class="navbar-nav ms-auto">
                    <!-- <li class="nav-item"><a class="nav-link active" href="index.php" data-bs-target="#modal-login" data-bs-toggle="modal">Admin</a></li> -->
                    <li class="nav-item"><a class="nav-link active" href="./assets/login.php">Admin</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active logout" href="./assets/logout.php">Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
